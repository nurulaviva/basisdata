$(document).ready(function () {
    $("#basic-alert").on("click", function () {
        ...
        $(".confirm-text").on("click", function () {
            var id = $(this).data('id');  // Ambil ID item yang ingin dihapus
            var type = $(this).data('type');  // Ambil tipe item ('menu' atau 'employee')
        
            // Tampilkan konfirmasi dengan SweetAlert
            Swal.fire({
                title: "Anda Yakin?",
                text: "Anda tidak akan dapat mengembalikannya!",
                icon: "warning",  // Ganti 'type' dengan 'icon' yang lebih sesuai dengan SweetAlert terbaru
                ...
                if (result.isConfirmed) {
                    // Kirim form DELETE berdasarkan tipe dan ID
                    if (type === 'menu') {
                        $("#delete-form-" + id).submit();  // Kirim form hapus menu
                    } else if (type === 'employee') {
                        $("#delete-form-" + id).submit();  // Kirim form hapus employee
                    }
        
                    // Tampilkan pesan penghapusan berhasil
                    Swal.fire({
                        icon: "success",
                        title: "Deleted!",
